...
alert('Wanna take part in an interesting quiz? \
    \nInstructions: On each question you have to choose answer, \
input 1 2 or 3 and click OK. \nLet`s go!');
...
points === 6 ? alert(`You answered on all questions and scored ${points} points, congratulations!`) :
